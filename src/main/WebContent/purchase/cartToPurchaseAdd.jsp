...
<body>
	...
	<div class="container" align="center">
		<form name="newPurchase" action="./PurchaseCartAddAction.doPu?id=${sessionId }" class="form-horizontal" method="post" onsubmit="return checkForm()">
			...
			%>
			<input name="productId" type="hidden" class="form-control" value="<%=cart.getProductId() %>" readonly>
			<div class="form-group row">
				<label class="col-sm-2 control-label" ><%=j+1 %>. Product</label>
				<div class="col-sm-6">
					<input name="pName" type="text" class="form-control" value="<%=cart.getpName() %>" readonly>
				</div>
			</div>
			<br>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input name="pPrice" type="text" class="form-control" value="<%=cart.getpPrice() %>" readonly>
				</div>
			</div>
			<br>
			<br>
			...
			<div class="row-sm" align="right"><strong>Total Price : <%=totalPrice %> ￦</strong><hr></div>
